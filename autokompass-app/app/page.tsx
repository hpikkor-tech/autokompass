      ...
      <section className="statwrap">
        <div className="wrap">
          <div className="statstrip">
            <div className="st"><div className="stn">1500+</div><div className="stl">töökoda kaardil</div></div>
            <div className="st"><div className="stn">105</div><div className="stl">linna ja valda</div></div>
