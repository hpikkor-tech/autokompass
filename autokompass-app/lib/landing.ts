...
export const CITIES: Record<string, LandingCity> = {
  ...
  parnu: { slug: 'parnu', name: 'Pärnu', ine: 'Pärnus', blurb: 'Pärnu töökojad on koondunud Riia maantee ja Papiniidu kanti. Suvepealinna eripära on hooajalisus — juunist augustini kasvab liiklus mitmekordseks ja vaba aega on tunduvalt raskem saada, seega tasub hooldus planeerida kas kevadesse või sügisesse.' },
  narva: { slug: 'narva', name: 'Narva', ine: 'Narvas', blurb: 'Narva on Eesti kolmas linn ja töökodade valik on siin ootamatult lai. Enamik teenindusi jääb Tallinna maantee ja Kreenholmi ümbrusse; osa neist teenindab ka piiriülest liiklust, mistõttu lahtiolekuajad on tavalisest pikemad.' },
  viljandi: { slug: 'viljandi', name: 'Viljandi', ine: 'Viljandis', blurb: 'Viljandi töökojad asuvad peamiselt Riia maantee ja Männimäe kandis. Linn on kompaktne — enamik teenindusi jääb kesklinnast kümne minuti sõidu kaugusele ning hinnatase on tuntavalt madalam kui Tallinnas.' },
  voru: { slug: 'voru', name: 'Võru', ine: 'Võrus', blurb: 'Võru on Lõuna-Eesti autohoolduse sõlmpunkt: siinsed töökojad Räpina ja Tartu maantee ääres teenindavad lisaks linnale ka suurt osa Võrumaast, seega tasub populaarsematesse kohtadesse aeg ette broneerida.' },
  johvi: { slug: 'johvi', name: 'Jõhvi', ine: 'Jõhvis', blurb: 'Jõhvi on Ida-Virumaa teeninduskeskus. Töökojad koonduvad Tartu maantee ja Rakvere tänava ümbrusse ning teenindavad lisaks Jõhvile ka Kohtla-Järve ja Ahtme autoomanikke.' },
  viimsi: { slug: 'viimsi', name: 'Viimsi', ine: 'Viimsis', blurb: 'Viimsi töökojad Randvere tee ja Muuga suunal on hea valik neile, kes ei taha hoolduseks Tallinna kesklinna sõita. Rehvitöökodade osakaal on siin keskmisest kõrgem.' },
  keila: { slug: 'keila', name: 'Keila', ine: 'Keilas', blurb: 'Keila töökojad Paldiski maantee kandis teenindavad kogu Harjumaa lääneosa — lisaks kohalikele ka Saue ja Laagri autoomanikke, kellele jääb Keila lähemale kui Tallinna kesklinn.' },
  kuressaare: { slug: 'kuressaare', name: 'Kuressaare', ine: 'Kuressaares', blurb: 'Kuressaare on Saaremaa ainus koht, kus valikut päriselt on. Suvel on surve suur ja parvlaevagraafik lisab oma piirangud, seega tasub aeg kokku leppida varem kui mandril.' },
  rapla: { slug: 'rapla', name: 'Rapla', ine: 'Raplas', blurb: 'Rapla jääb Tallinna ja Pärnu vahele ning töökojad on koondunud Tallinna maantee äärde. Hinnatase on pealinnaga võrreldes tuntavalt madalam, mistõttu käib siin hooldusel ka Harjumaa lõunaosa rahvast.' },
  'kohtla-jarve': { slug: 'kohtla-jarve', name: 'Kohtla-Järve', ine: 'Kohtla-Järvel', blurb: 'Kohtla-Järve töökojad jagunevad Järve ja Ahtme linnaosa vahel. Siin on palju väiksemaid remonditöökodi, kus tehakse lisaks tavahooldusele ka keevitus- ja kohandustöid, mida suuremad teenindused enam ei võta.' },
  maardu: { slug: 'maardu', name: 'Maardu', ine: 'Maardus', blurb: 'Maardu töökojad Peterburi tee ääres jäävad mugavalt teele nii Lasnamäelt kui Viimsist. Muuga sadama lähedus tähendab, et mitmed teenindused on harjunud ka veokite ja haagistega.' },
  haapsalu: { slug: 'haapsalu', name: 'Haapsalu', ine: 'Haapsalus', blurb: 'Haapsalu töökojad asuvad Tallinna maantee ja Uuemõisa suunal. Läänemaa keskusena teenindavad need ka ümberkaudseid valdu, seega on hooajal — eriti rehvivahetuse ajal — mõistlik helistada ette.' },
  saue: { slug: 'saue', name: 'Saue', ine: 'Sauel', blurb: 'Saue töökojad Tule tänava tööstusala kandis on Tallinna lähivalla mugav alternatiiv: pealinnast jääb siia veerand tundi sõitu, aga tunnihinnad on madalamad ja järjekorrad lühemad.' },
  paide: { slug: 'paide', name: 'Paide', ine: 'Paides', blurb: 'Paide asub Eesti geograafilises keskmes, Tallinna ja Tartu maantee ristumiskohas. Töökojad on harjunud ka läbisõitjatega — kui midagi juhtub pikal sõidul, on see üks väheseid kohti Kesk-Eestis, kus abi tegelikult saab.' },
  valga: { slug: 'valga', name: 'Valga', ine: 'Valgas', blurb: 'Valga töökojad Riia ja Kuperjanovi tänava kandis teenindavad piirilinna eripära arvestades ka Läti poolt tulevaid autosid. Hinnad on Eesti madalamate seas.' },
...
export const SERVICES: Service[] = [
  {
    ...
    cities: ['tallinn', 'tartu', 'parnu', 'viimsi', 'viljandi', 'voru', 'rakvere', 'rapla'],
  ...
  },
  {
    ...
    cities: ['tallinn', 'tartu', 'parnu', 'narva', 'viljandi', 'voru', 'johvi', 'viimsi', 'keila', 'rakvere', 'kuressaare', 'rapla', 'kohtla-jarve', 'maardu', 'haapsalu', 'saue', 'paide', 'valga'],
  ...
  },
  {
    ...
    cities: ['tallinn', 'tartu', 'parnu', 'narva', 'viljandi', 'voru', 'johvi', 'keila', 'rakvere', 'kuressaare', 'rapla', 'kohtla-jarve', 'maardu', 'haapsalu'],
    districts: ['lasnamae', 'kesklinn', 'kristiine', 'mustamae', 'nomme', 'pohja-tallinn', 'haabersti', 'pirita'],
  },
  {
